...
Run:  uv run uvicorn app.backend.app:app --reload --port 8787   (from the repo root)
"""
...
from app.backend import autohunt_view
from app.backend import bulk
from app.backend import caps
from app.backend import chat
from app.backend import data
from app.backend import deep_search
from app.backend import decisions
from app.backend import executor
from app.backend import feedback
from app.backend import instance
from app.backend import issue_data
from app.backend import issues as issues_mod
from app.backend import jobs
from app.backend import freshness_live
from app.backend import models
from app.backend import pipeline_status
from app.backend import pr_history
from app.backend import pr_search
from app.backend import repo_meta
from app.backend import review_refresh
from app.backend import responses as responses_mod
from app.backend import service
from app.backend import tables
