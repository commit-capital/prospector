...
safety_guard (gh pr diff) and caches to app/cache/diffs/<sha>.diff.
"""
...
from app.backend import filters  # spec predicate + preset expanders
from app.backend import pr_checks
