...
uv run uvicorn prospector_app.backend.app:app --port 8787 --reload
# frontend
pnpm --dir prospector_app/frontend install
...
uv run uvicorn prospector_app.backend.app:app --port 8787   # open http://localhost:8787
```
