...
tier-0 candidates first. One gate consumes it: `gates.resolve_autopush_bar`
parks a tier-0 conflict resolution for a human. No merge, threat, or
security policy reads it, and the threat scan stays path-blind (a
