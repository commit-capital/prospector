...
pipeline and web app configured by `TRIAGE_REPO` and
...
2. If the user provided a focus area (e.g., "clustering accuracy", "app UX", "security gate", "issue triage", "executor safety"), note it for the agent. Otherwise, prepare for an open-ended review.
