...
Landed on main outside this plan as PR #274: `run_agent` takes `read_root` (one
root or several), `env_allow`, and `git_root`. The lane uses them as they stand;
this plan changes nothing in `pipeline/headless_agent.py`.
